    ...
    Column(
        ...
        Box(modifier = Modifier.fillMaxWidth()) {
            ...
            Box(
                ...
                Text( electronic.priceCurrency.substring(0,3) +" "
        ...
        Row(
            ...
            Column(
                ...
                TextBox(
                    ...
                    maxLines = 1,
                    size = 13,
                    text = electronic.brand+" "+electronic.modelNumber,
        ...
        if (!segment) {
            electronic.description.let { safeChannelName ->
                Row(
...
/*
object fashionThumbnailCardDefaults {

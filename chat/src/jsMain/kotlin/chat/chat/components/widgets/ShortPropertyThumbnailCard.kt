...
@Composable
fun ShortPropertyThumbnailCard(
    details: Property,
    ...
    Column(
        modifier = Modifier
            ...
            .noShrink()
            .onClick { navigator.pushRoute(Route.Short(id = BASE_URL + FILES + details.video1)) }
        ...
        Box(contentAlignment = Alignment.TopEnd) {
            Image(
                ...
                //src =  BASE_URL + FILES + details.video1,
...
object ShortPropertyThumbnailCardDefaults {

package chat.chat.components.widgets.context
...
import chat.chat.utils.PaddingValues
...
fun TextField(
    ...
    TextInput(value = textState.value) {
        ...
        style {
            containerColor?.let { bg -> background(Background.list(bg)) } ?: run { background(Background.None) }

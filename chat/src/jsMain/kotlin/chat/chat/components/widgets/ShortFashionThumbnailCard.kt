...
fun ShortFashionThumbnailCard(
    ...
    //console.info("ShortFashionThumbnailCard URL = "+BASE_URL + FILES + fashion.video1)
    ...
    Column(
        modifier = Modifier
            ...
            .noShrink()
            .onClick {
                navigator.pushRoute(Route.VideoFashion(id = fashion.id.toString()))
//                navigator.pushRoute(Route.Short(id = fashion.id.toString()))
                //ShortsGrid(true)
            }
        ...
        Box(contentAlignment = Alignment.BottomEnd) {
            Image(
                ...
                src =  BASE_URL + FILES + fashion.img1,
        ...
        Column(modifier = Modifier.color(Styles.VIDEO_CARD_SECONDARY_TEXT)) {
            ...
            val amount = fashion.priceCurrency.substring(0,1) +" "+
                    numberCalculation( fashion.priceMain ).toString()
            ...
            Box(Modifier.limitTextWithEllipsis()) {
                TextBox( fashion.description ,  size=14, maxLines=2 )
            }
        }
    }
}
...
/*
object ShortFashionThumbnailCardDefaults {

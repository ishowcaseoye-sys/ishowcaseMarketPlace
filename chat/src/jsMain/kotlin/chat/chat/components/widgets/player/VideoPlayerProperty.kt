...
import chat.chat.components.widgets.ContextMenu
import chat.chat.components.widgets.ContextMenuAnimationDirection
import chat.chat.components.widgets.context.ContextMenuPage
import chat.chat.components.widgets.context.VideoOptionPage
import chat.chat.pages.SegmentedContentType
import chat.chat.utils.Asset
import chat.chat.utils.Constants
import chat.chat.utils.FadeInOut
import chat.chat.utils.SpacedRow
import chat.chat.utils.Styles
import chat.chat.utils.rememberElementWidthAsState
...
fun VideoPlayerProperty(
    ...
    console.info("VideoPlayer = $videoId")
                    ...
                    Row(
                        ...
                        if (displayQualityButton) {
                            AssetImageButton(
                                ...
                                openedPopupType =
                                    if (openedPopupType == PopupType.QualityOptions) null
...
enum class VideoQualityProperty { P144, P240, P360, P480, P720, P1080, P4K }
private enum class PopupTypeProperty { VideoOptions, QualityOptions }

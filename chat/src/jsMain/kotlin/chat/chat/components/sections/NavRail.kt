...
import chat.chat.components.widgets.Popup
import chat.chat.models.NavRailItemData
import chat.chat.models.NavRailListItemIconType
...
import chat.chat.utils.onMouseEvent
import chat.chat.utils.removeMouseEventListeners
...
private fun NavRailListItem(
    ...
    Row(
        ...
        Row(
            ...
            modifier = Modifier.background(animatedBGColor.toKobwebColor())
                .borderRadius(10.px)
        ...
        if (isHorizontallyExpandedState.value && hasChildren) {
            ...
            Box(
                ...
                modifier = Modifier.background(animatedDropDownBGColor.toKobwebColor())
                    .borderRadius(10.px)
